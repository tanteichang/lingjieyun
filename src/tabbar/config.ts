...
export const nativeTabbarList: NativeTabBarItem[] = [
  ...
  {
    text: '项目广场',
    pagePath: 'pages/project-square/project-square',
    iconPath: 'static/tabbar/project-square.png',
    selectedIconPath: 'static/tabbar/project-square_selected.png',
  },
  {
...
export const customTabbarList: CustomTabBarItem[] = [
  {
    ...
    iconActive: 'static/tabbar/home_selected.png',
  },
  {
    text: '项目广场',
    pagePath: 'pages/project-square/project-square',
    iconType: 'image',
    icon: 'static/tabbar/project-square.png',
    iconActive: 'static/tabbar/project-square_selected.png',
  },
  {
    text: '消息',
    pagePath: 'pages/message/message',
    ...
    iconActive: 'static/tabbar/message_selected.png',
  },
  {
    pagePath: 'pages/me/me',
    text: '我的',
